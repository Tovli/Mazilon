...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String homePagePersonalPlanSecondaryTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male': 'Things that will make me feel well now',
      'female': 'Things that will make me feel well now',
      'other': 'Things that will make me feel well now',
    });
    return '$_temp0';
  }
  ...
  String homePageThanksSecondaryTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male': 'I\'m thankful for',
      'female': 'I\'m thankful for',
      'other': 'I\'m thankful for',
    });
    return '$_temp0';
  }
  ...
  String homePageThankyouPopup(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'This is the way to strengthen your positive happiness muscle. The recommendation is to thank for at least 5 things in your life every day. Keep up the good work, and we\'ll meet again tomorrow',
      'female':
          'This is the way to strengthen your positive happiness muscle. The recommendation is to thank for at least 5 things in your life every day. Keep up the good work, and we\'ll meet again tomorrow',
      'other':
          'This is the way to strengthen your positive happiness muscle. The recommendation is to thank for at least 5 things in your life every day. Keep up the good work, and we\'ll meet again tomorrow',
  ...
  String homePagePositiveTraitPopup(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'The recommendation is to look at your list of virtues every day. And when there\'s something to add, don\'t be shy—add it without judgment and with a full heart.',
      'female':
          'The recommendation is to look at your list of virtues every day. And when there\'s something to add, don\'t be shy—add it without judgment and with a full heart.',
      'other':
          'The recommendation is to look at your list of virtues every day. And when there\'s something to add, don\'t be shy—add it without judgment and with a full heart.',
  ...
  String sharePageSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'You\'ve created a guide that will help you during moments of crisis! Let\'s explore more tools for self-help and mental resilience',
      'female':
          'You\'ve created a guide that will help you during moments of crisis! Let\'s explore more tools for self-help and mental resilience',
      'other':
          'You\'ve created a guide that will help you during moments of crisis! Let\'s explore more tools for self-help and mental resilience',
  ...
  String userSettingsGender(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male': 'How would you like to be referred to?',
      'female': 'How would you like to be referred to?',
      'other': 'How would you like to be referred to?',
    });
    return '$_temp0';
  }
  ...
  String introductionFormFirstPageSubTitle1(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'Living Positively - for improving quality of life, increasing resilience, and happiness',
      'female':
          'Living Positively - for improving quality of life, increasing resilience, and happiness',
      'other':
          'Living Positively - for improving quality of life, increasing resilience, and happiness',
  ...
  String introductionFormLastPageSubTitle1(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'You are invited to create a personal plan that will provide you and your surroundings with support in moments when everything becomes too much',
      'female':
          'You are invited to create a personal plan that will provide you and your surroundings with support in moments when everything becomes too much',
      'other':
          'You are invited to create a personal plan that will provide you and your surroundings with support in moments when everything becomes too much',
  ...
  String introductionFormLastPageSubTitle2(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'It is recommended to dedicate a few minutes now, to easily navigate future moments of crisis',
      'female':
          'It is recommended to dedicate a few minutes now, to easily navigate future moments of crisis',
      'other':
          'It is recommended to dedicate a few minutes now, to easily navigate future moments of crisis',
  ...
  String introductionFormSecondPageSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'Hi, we\'re happy you\'re here! We\'d love to get to know you a bit so we can know how to address you',
      'female':
          'Hi, we\'re happy you\'re here! We\'d love to get to know you a bit so we can know how to address you',
      'other':
          'Hi, we\'re happy you\'re here! We\'d love to get to know you a bit so we can know how to address you',
  ...
  String distractionsMidSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male': 'Click to add options that suit you to your personal plan',
      'female': 'Click to add options that suit you to your personal plan',
      'other': 'Click to add options that suit you to your personal plan',
    });
    return '$_temp0';
  }
  ...
  String feelBetterSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'What helps me improve my mood, relax, feel a little less stress. Ways I should use and rely on for preventive maintenance, and when needed in emergency situations, even increase dosages',
      'female':
          'What helps me improve my mood, relax, feel a little less stress. Ways I should use and rely on for preventive maintenance, and when needed in emergency situations, even increase dosages',
      'other':
          'What helps me improve my mood, relax, feel a little less stress. Ways I should use and rely on for preventive maintenance, and when needed in emergency situations, even increase dosages',
  ...
  String makeSaferSubTitle(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male': 'Ways the environment can help me cope',
      'female': 'Ways the environment can help me cope',
      'other': 'Ways the environment can help me cope',
    });
    return '$_temp0';
  }
  ...
  String phonesPageHeader(String gender) {
    String _temp0 = intl.Intl.selectLogic(gender, {
      'male':
          'Who are the people that support me, whom I can turn to if I am in distress or thinking of harming myself',
      'female':
          'Who are the people that support me, whom I can turn to if I am in distress or thinking of harming myself',
      'other':
          'Who are the people that support me, whom I can turn to if I am in distress or thinking of harming myself',
