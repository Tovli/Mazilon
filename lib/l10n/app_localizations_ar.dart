...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String distractionsListNo22(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'زيادة الانبساطية',
        'female': 'زيادة الانبساطية',
        'other': 'زيادة الانبساطية',
      },
    );
    return '$_temp0';
  }
  ...
  String distractionsListNo23(String gender) {
    String _temp0 = intl.Intl.selectLogic(
      gender,
      {
        'male': 'الانخراط المفرط',
        'female': 'الانخراط المفرط',
        'other': 'الانخراط المفرط',
      },
    );
    return '$_temp0';
  }
